...
DATABASE_DATA_PATH = /home/$(shell whoami)/data/mysql
WB_DATA_PATH = /home/$(shell whoami)/data/wordpress
...
ensure_dirs:
    ...
    @echo "Directories ready: $(WB_DATA_PATH), $(DATABASE_DATA_PATH), $(DATA_PATH)"
